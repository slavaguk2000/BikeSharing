...
<div class="site-wrap">
    ...
    <div class="w3ls-pos">
        ...
        <div class="w3ls-login">
            ...
            <form action="${pageContext.request.contextPath}/renTrip" enctype="multipart/form-data" method="post"
            style="padding: 0 0 1vw;">

                <div class="agile-field-txt" style="margin-bottom: 0.5em">
                    <input type="text" name="value" id="name" pattern="[A-Za-zА-Яа-я\d\s\-_\.]{1,45}"
                           maxlength="45" placeholder="${bike.name}"
                           title="[A-Za-zА-Яа-я\d\s\-_\.]{1,45}" required/>
                </div>
                <input type="submit" value="Save" class="btn btn-primary">
                <input type="hidden" name="command" value="save_edit_bike"/>
                <input type="hidden" name="field" value="name"/>
            </form>
            <div style="font-size: large">Cost</div>
            <form action="${pageContext.request.contextPath}/renTrip" enctype="multipart/form-data" method="post"
                  style="padding: 0 0 1vw;">
            ...
            <div style="font-size: large">Address</div>
            <form action="${pageContext.request.contextPath}/renTrip" enctype="multipart/form-data" method="post"
                  style="padding: 0 0 1vw;">
