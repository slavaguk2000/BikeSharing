      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-6 col-xl-2">
            <h1 class="mb-0 site-logo"><a href="index.jsp" class="h2 mb-0">RenTrip<span class="text-primary">.</span> </a></h1>
          </div>
          ...
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <li>
                    <a href="renTrip?command=bikes" class="nav-link">Bicycles</a>
                </li>
        ...
        <div class="row">
          <div class="col-md-7 align-self-center text-center text-md-left">
            <div class="intro-text">
              ...
              <p class="mb-4">Whether you are travelling and want to see the sights, <span class="d-block"> or are looking for a high performance ride in the back-country, </span> we've got your bike.</p>
            </div>
          </div>
